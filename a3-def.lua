...
function deletestatus()
	r,g,b = getColorRGB(390,810);
	if r == 211 and g == 100 and b == 68 then
...
function click30yellow(r, g, b)
	if r == 252 and g == 212 and b == 102 then
		local x;
		x = click(x_30,y_30,0,0);
		if x then
...
function click15yellow(r, g, b)
	if r == 247 and g == 211 and b == 96 then
		local x;
		x = click(x_15,y_15,0,0);
		if x then
